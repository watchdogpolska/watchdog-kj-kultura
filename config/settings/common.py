# -*- coding: utf-8 -*-
"""
Django settings for watchdog-kj-kultura project.
...
# ------------------------------------------------------------------------------
MIGRATION_MODULES = {
    'sites': 'watchdog_kj_kultura.contrib.sites.migrations'
}
...
ACCOUNT_ADAPTER = 'watchdog_kj_kultura.users.adapters.AccountAdapter'
SOCIALACCOUNT_ADAPTER = 'watchdog_kj_kultura.users.adapters.SocialAccountAdapter'
