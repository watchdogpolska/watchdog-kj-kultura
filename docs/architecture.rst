...
Aplikacja została wykonana zaimplentowana w języku Python 3.5 z wsparciem frameworku `Django 1.10`_. Została zaprojektowania do wykorzystania bazy danych `PostgreSQL 9.5`_ z modułem PostGIS i silnika pełnotekstowej wyszukiwarki `Elasticsearch 2.4.3`_
...
.. _`Elasticsearch 2.4.3`: https://www.elastic.co/
