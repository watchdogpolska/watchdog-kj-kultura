# -*- coding: utf-8 -*-
#
# watchdog-kj-kultura documentation build configuration file, created by
# sphinx-quickstart.
#
...
htmlhelp_basename = 'watchdog_kj_kulturadoc'
...
man_pages = [
    ('index', 'watchdog_kj_kultura', 'watchdog-kj-kultura Documentation',
     ["""Adam Dobrawy"""], 1)
]
...
texinfo_documents = [
    ('index', 'watchdog_kj_kultura', 'watchdog-kj-kultura Documentation',
     """Adam Dobrawy""", 'watchdog-kj-kultura',
     """Projekt prezentacji danych o kulturze realizowany z Klubem Jagielońskim.""", 'Miscellaneous'),
]
